...
public class ClassBatchServiceImpl implements ClassBatchService {
	...
	public ClassBatchServiceImpl(RestTemplateBuilder builder) {
	...
	public String submitClassById(Long classId) {
		...
		ResponseEntity<ResponseObject> respEntity = restTemplate.exchange(
				"http://localhost:8100/api/classBatch/submit?classId=" + classId, HttpMethod.PUT, null,
				ResponseObject.class);
		return respEntity.getBody().getMessage();
	}
	...
	public String approveSubmittedClass(Long classId) {
		...
		ResponseEntity<ResponseObject> respEntity = restTemplate.exchange(
				"http://localhost:8100/api/classBatch/approve?classId=" + classId, HttpMethod.PUT, null,
				ResponseObject.class);
		return respEntity.getBody().getMessage();
	}
	...
	public String rejectSubmittedClass(ClassBatchDto classInfo) {
		// TODO Auto-generated method stub
		HttpEntity<ClassBatchDto> request = new HttpEntity<>(classInfo);
		ResponseEntity<ResponseObject> respEntity = restTemplate.exchange("http://localhost:8100/api/classBatch/reject",
				HttpMethod.PUT, request, ResponseObject.class);
		return respEntity.getBody().getMessage();
	}
	...
	public String closeClassById(List<Long> classIds) {
		...
		ResponseEntity<ResponseObject> responseEntity = restTemplate
				.exchange("http://localhost:8100/api/classBatch/close", HttpMethod.PUT, request, ResponseObject.class);
